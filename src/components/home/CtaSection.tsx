  ...
  return (
    <section className="relative overflow-hidden">
      <motion.div className="container relative z-10">
        ...
        once: true,
        margin: "-100px"
      }} className="max-w-5xl mx-auto text-center bg-card px-4 pt-4 pb-0 rounded-2xl shadow-xl border border-primary/10 backdrop-blur-sm">
          <h2 className="mb-1 text-primary text-3xl md:text-4xl font-bold">Book Your Discovery Call</h2>
