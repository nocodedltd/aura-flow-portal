        ...
        <motion.div className="container relative z-10" initial="hidden" animate="visible" variants={heroContainer}>
          <div className="max-w-3xl mx-auto text-center">
            ...
            stiffness: 70
              ...
              <img src="/lovable-uploads/5474f216-66de-4286-8816-9b3b1bea942f.png" alt="NoCoded logo" className="h-14 md:h-16 w-auto drop-shadow-[0_0_15px_rgba(249,222,201,0.3)]" style={{
              maxWidth: "360px"
            }} />
            </motion.div>
            ...
            {/* Subtitle */}
            <motion.p className="text-xl text-secondary mb-8 max-w-2xl mx-auto" variants={heroSubtitle}>Optimise processes, cut costs, and scale intelligently.</motion.p>
